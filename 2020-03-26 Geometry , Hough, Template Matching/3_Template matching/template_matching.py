...
for OH in range(oH):
    for OW in range(oW):
        ...
        # axis=(-1, -2) cioè fai somma per tutte le feature map (: = N) su quella porzione 2x3 (h_start:h_end, w_start:w_end) del template e dell input
